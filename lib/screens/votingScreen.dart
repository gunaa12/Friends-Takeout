...
import 'package:friends_takeout/secureInfo.dart';
...
class _VotingScreenState extends State<VotingScreen> {
                                              ...
                                              child: Container(
                                                ...
                                                child: CircleAvatar(
                                                  ...
                                                  backgroundImage: NetworkImage(
                                                    "https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photo_reference=${list[index]["photos"][0]["photo_reference"]}&key=${apiKey}",
                                                  ),
                                                ),
                                              ),
                                              flex: 1,
  ...
  Future<Map<String, dynamic>> makeRequest() async {
    ...
    String url = 'https://maps.googleapis.com/maps/api/place/nearbysearch/json?key=${apiKey}&location=${locationData.latitude},${locationData.longitude}&radius=5000&type=restaurant';
